...
export function currentJson(branch, context) {
    return {
        ok: true,
        branch,
...
export function currentMarkdown(branch, context) {
...
export function candidatePublicContext(candidate) {
...
export function currentCandidateJson(branch, candidate, migratedLegacy = false) {
    return {
        ok: true,
        branch,
...
export function currentCandidateMarkdown(candidate) {
    const item = candidate.workItem;
    const lines = [
...
export function renderActiveContext(candidate) {
    const item = candidate.workItem;
