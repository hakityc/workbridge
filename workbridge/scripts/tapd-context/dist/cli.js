...
import { FLOW_SPEC_FILE, initializeFlowSpec, readAndValidateFlowSpec, renderFlowRequirement, } from "./spec.js";
...
function flowSpecStatus(repoRoot) {
    ...
    try {
        ...
        const cliError = error instanceof CliError ? error : new CliError("UNEXPECTED_ERROR", String(error));
        return {
            path: FLOW_SPEC_FILE,
            exists: true,
            valid: false,
